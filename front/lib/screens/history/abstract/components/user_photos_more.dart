...
import 'package:front/screens/history/abstract/components/user_photos_more_details.dart';
...
class UserPhotosMore extends StatelessWidget {
  const UserPhotosMore({Key? key}) : super(key: key);
                    ...
                    return RawMaterialButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UserPhotosMoreDetails(
